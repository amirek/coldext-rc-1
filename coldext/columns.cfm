...
<cfparam name="attributes.layout" default="column">
...
<cfif not thisTag.hasEndTag>
	<cfthrow message="columns missing closing tag">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = new Ext.layout.ColumnLayout(</cfif>{
