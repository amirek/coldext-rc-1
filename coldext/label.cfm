...
<cfparam name="attributes.forId" default=""><!--- @@type: String @@help: The id of the input element to which this label will be bound via the standard HTML 'for' attribute. If not specified, the attribute will not be added to the label. --->
<cfparam name="attributes.forIdJS" default=""><!--- @@type: JS @@help: The id of the input element to which this label will be bound via the standard HTML 'for' attribute. If not specified, the attribute will not be added to the label. --->
...
<cfparam name="attributes.html" default=""><!--- @@type: String @@help: An HTML fragment that will be used as the label's innerHTML (defaults to ''). Note that if text is specified it will take precedence and this value will be ignored. --->
<cfparam name="attributes.htmlJS" default=""><!--- @@type: JS @@help: An HTML fragment that will be used as the label's innerHTML (defaults to ''). Note that if text is specified it will take precedence and this value will be ignored. --->
...
<cfparam name="attributes.text" default=""><!--- @@type: String @@help: The plain text to display within the label (defaults to ''). If you need to include HTML tags within the label's innerHTML, use the html config instead. --->
<cfparam name="attributes.textJS" default=""><!--- @@type: JS @@help: The plain text to display within the label (defaults to ''). If you need to include HTML tags within the label's innerHTML, use the html config instead. --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.form.Label({
		...
		<cfif AttributeNotEmpty("forId")>forId: "#JSStringFormat(attributes.forId)#",</cfif>
		<cfif AttributeNotEmpty("forIdJS")>forId: #attributes.forIdJS#,</cfif>
