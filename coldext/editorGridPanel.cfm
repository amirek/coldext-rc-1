...
<cfparam name="attributes.selModel" default=""><!--- @@type: Object @@help: Any subclass of AbstractSelectionModel that will provide the selection model for the grid (defaults to Ext.grid.CellSelectionModel if not specified). Note that the SelectionModel must be compatible with the model of selecting cells individually, and should support a method named getSelectedCell (for these reasons, Ext.grid.RowSelectionModel is not compatible). --->
...
<cfif not thisTag.hasEndTag>
	<cfthrow message="editorGridPanel missing closing tag">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.grid.EditorGridPanel({
