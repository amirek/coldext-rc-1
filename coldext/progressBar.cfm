...
<cfparam name="attributes.animate" default=""><!--- @@type: Boolean @@help: True to animate the progress bar during transitions (defaults to false) --->
...
<cfparam name="attributes.baseCls" default=""><!--- @@type: String @@help: The base CSS class to apply to the progress bar's wrapper element (defaults to 'x-progress') --->
<cfparam name="attributes.baseClsJS" default=""><!--- @@type: JS @@help: The base CSS class to apply to the progress bar's wrapper element (defaults to 'x-progress') --->
...
<cfparam name="attributes.id" default=""><!--- @@type: String @@help: The progress bar element's id (defaults to an auto-generated id) --->
<cfparam name="attributes.idJS" default=""><!--- @@type: JS @@help: The progress bar element's id (defaults to an auto-generated id) --->
...
<cfparam name="attributes.text" default=""><!--- @@type: String @@help: The progress bar text (defaults to '') --->
<cfparam name="attributes.textJS" default=""><!--- @@type: JS @@help: The progress bar text (defaults to '') --->
<cfparam name="attributes.textEl" default=""><!--- @@type: String @@help: The element to render the progress text to (defaults to the progress bar's internal text element) --->
<cfparam name="attributes.textElJS" default=""><!--- @@type: Mixed @@help: The element to render the progress text to (defaults to the progress bar's internal text element) --->
<cfparam name="attributes.value" default=""><!--- @@type: Float @@help: A floating point value between 0 and 1 (e.g., .5, defaults to 0) --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.ProgressBar({
		...
		<cfif AttributeNotEmpty("textEl")>textEl: "#JSStringFormat(attributes.textEl)#",</cfif>
		<cfif AttributeNotEmpty("textElJS")>textEl: #attributes.textElJS#,</cfif>
		<cfif AttributeNotEmpty("value")>value: #attributes.value#,</cfif>
