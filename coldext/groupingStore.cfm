...
<cfparam name="attributes.groupField" default=""><!--- @@type: String @@help: The field name by which to sort the store's data (defaults to ''). --->
<cfparam name="attributes.groupFieldJS" default=""><!--- @@type: JS @@help: The field name by which to sort the store's data (defaults to ''). --->
<cfparam name="attributes.groupOnSort" default=""><!--- @@type: Boolean @@help: True to sort the data on the grouping field when a grouping operation occurs, false to sort based on the existing sort info (defaults to false). --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.data.GroupingStore({
		...
		<cfif AttributeNotEmpty("groupField")>groupField: "#JSStringFormat(attributes.groupField)#",</cfif>
		<cfif AttributeNotEmpty("groupFieldJS")>groupField: #attributes.groupFieldJS#,</cfif>
		<cfif AttributeNotEmpty("groupOnSort")>groupOnSort: #attributes.groupOnSort#,</cfif>
		...
		<cfif AttributeNotEmpty("remoteGroup")>remoteGroup: #attributes.remoteGroup#,</cfif>
		...
		<cfif AttributeNotEmpty("sortInfo")>sortInfo: #attributes.sortInfo#,
		<cfelse><cfif AttributeNotEmpty("groupField")>sortInfo: { field: "#attributes.groupField#", direction: "ASC"},</cfif></cfif>
