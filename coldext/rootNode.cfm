...
<cfparam name="attributes.dummy" default=""><!--- @@type: String @@help: This is a dummy attribute. --->
<cfparam name="attributes.dummyJS" default=""><!--- @@type: JS @@help: This is a dummy attribute. --->
...
<cfif not thisTag.hasEndTag>
	<cfthrow message="rootNode missing closing tag">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.tree.AsyncTreeNode({
		...
		<cfif AttributeNotEmpty("dummy")>dummy: "#JSStringFormat(attributes.dummy)#",</cfif>
		<cfif AttributeNotEmpty("dummyJS")>dummy: #attributes.dummyJS#,</cfif>
		...
		expanded: true, <!--- TODO: allow customisation (probably default to true though) --->
		dummy: true
