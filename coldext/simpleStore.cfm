...
<cfparam name="attributes.data" default=""><!--- @@type: Array @@help: The multi-dimensional array of data. --->
<cfparam name="attributes.fields" default=""><!--- @@type: Array @@help: An array of field definition objects, or field name string as specified to Ext.data.Record.create --->
<cfparam name="attributes.id" default=""><!--- @@type: Number @@help: The array index of the record id. Leave blank to auto generate ids. --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.data.SimpleStore({
		...
		<cfif AttributeNotEmpty("id")>id: #attributes.id#,</cfif>
