...
<cfparam name="attributes.animate" default=""><!--- @@type: Boolean @@help: true to enable animated expand/collapse (defaults to the value of Ext.enableFx) --->
...
<cfparam name="attributes.containerScroll" default=""><!--- @@type: Boolean @@help: true to register this container with ScrollManager --->
...
<cfparam name="attributes.ddAppendOnly" default=""><!--- @@type: String @@help: True if the tree should only allow append drops (use for trees which are sorted) --->
<cfparam name="attributes.ddAppendOnlyJS" default=""><!--- @@type: JS @@help: True if the tree should only allow append drops (use for trees which are sorted) --->
<cfparam name="attributes.ddGroup" default=""><!--- @@type: String @@help: The DD group this TreePanel belongs to --->
<cfparam name="attributes.ddGroupJS" default=""><!--- @@type: JS @@help: The DD group this TreePanel belongs to --->
<cfparam name="attributes.ddScroll" default=""><!--- @@type: Boolean @@help: true to enable body scrolling --->
<cfparam name="attributes.disabled" default=""><!--- @@type: Boolean @@help: Render this component disabled (default is false). --->
<cfparam name="attributes.dragConfig" default=""><!--- @@type: Object @@help: Custom config to pass to the Ext.tree.TreeDragZone instance --->
...
<cfparam name="attributes.dropConfig" default=""><!--- @@type: Object @@help: Custom config to pass to the Ext.tree.TreeDropZone instance --->
<cfparam name="attributes.enableDD" default=""><!--- @@type: Boolean @@help: true to enable drag and drop --->
<cfparam name="attributes.enableDrag" default=""><!--- @@type: Boolean @@help: true to enable just drag --->
<cfparam name="attributes.enableDrop" default=""><!--- @@type: Boolean @@help: true to enable just drop --->
...
<cfparam name="attributes.hlColor" default=""><!--- @@type: String @@help: The color of the node highlight (defaults to C3DAF9) --->
<cfparam name="attributes.hlColorJS" default=""><!--- @@type: JS @@help: The color of the node highlight (defaults to C3DAF9) --->
<cfparam name="attributes.hlDrop" default=""><!--- @@type: Boolean @@help: false to disable node highlight on drop (defaults to the value of Ext.enableFx) --->
...
<cfparam name="attributes.lines" default=""><!--- @@type: Boolean @@help: false to disable tree lines (defaults to true) --->
...
<cfparam name="attributes.loader" default=""><!--- @@type: Ext.tree.TreeLoader @@help: A Ext.tree.TreeLoader for use with this TreePanel --->
...
<cfparam name="attributes.pathSeparator" default=""><!--- @@type: String @@help: The token used to separate sub-paths in path strings (defaults to '/') --->
<cfparam name="attributes.pathSeparatorJS" default=""><!--- @@type: JS @@help: The token used to separate sub-paths in path strings (defaults to '/') --->
...
<cfparam name="attributes.root" default=""><!--- @@type: Ext.tree.TreeNode @@help: The root node for the tree. --->
<cfparam name="attributes.rootVisible" default=""><!--- @@type: Boolean @@help: false to hide the root node (defaults to true) --->
<cfparam name="attributes.selModel" default=""><!--- @@type: Boolean @@help: A tree selection model to use with this TreePanel (defaults to a Ext.tree.DefaultSelectionModel) --->
...
<cfparam name="attributes.singleExpand" default=""><!--- @@type: Boolean @@help: true if only 1 node per branch may be expanded --->
...
<cfparam name="attributes.trackMouseOver" default=""><!--- @@type: Boolean @@help: False to disable mouse over highlighting --->
<cfparam name="attributes.useArrows" default=""><!--- @@type: Boolean @@help: True to use Vista-style arrows in the tree (defaults to false) --->
...
<cfif not thisTag.hasEndTag>
	<cfthrow message="treePanel missing closing tag">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.tree.TreePanel({
		...
		<cfif AttributeNotEmpty("animate")>animate: #attributes.animate#,</cfif>
		...
		<cfif AttributeNotEmpty("containerScroll")>containerScroll: #attributes.containerScroll#,</cfif>
		...
		<cfif AttributeNotEmpty("ddAppendOnly")>ddAppendOnly: "#JSStringFormat(attributes.ddAppendOnly)#",</cfif>
		<cfif AttributeNotEmpty("ddAppendOnlyJS")>ddAppendOnly: #attributes.ddAppendOnlyJS#,</cfif>
		<cfif AttributeNotEmpty("ddGroup")>ddGroup: "#JSStringFormat(attributes.ddGroup)#",</cfif>
		<cfif AttributeNotEmpty("ddGroupJS")>ddGroup: #attributes.ddGroupJS#,</cfif>
		<cfif AttributeNotEmpty("ddScroll")>ddScroll: #attributes.ddScroll#,</cfif>
		<cfif AttributeNotEmpty("disabled")>disabled: #attributes.disabled#,</cfif>
		<cfif AttributeNotEmpty("dragConfig")>dragConfig: #attributes.dragConfig#,</cfif>
		<cfif AttributeNotEmpty("draggable")>draggable: #attributes.draggable#,</cfif>
		<cfif AttributeNotEmpty("dropConfig")>dropConfig: #attributes.dropConfig#,</cfif>
		<cfif AttributeNotEmpty("enableDD")>enableDD: #attributes.enableDD#,</cfif>
		<cfif AttributeNotEmpty("enableDrag")>enableDrag: #attributes.enableDrag#,</cfif>
		<cfif AttributeNotEmpty("enableDrop")>enableDrop: #attributes.enableDrop#,</cfif>
		...
		<cfif AttributeNotEmpty("hlColor")>hlColor: "#JSStringFormat(attributes.hlColor)#",</cfif>
		<cfif AttributeNotEmpty("hlColorJS")>hlColor: #attributes.hlColorJS#,</cfif>
		<cfif AttributeNotEmpty("hlDrop")>hlDrop: #attributes.hlDrop#,</cfif>
		...
		<cfif AttributeNotEmpty("lines")>lines: #attributes.lines#,</cfif>
		...
		<cfif AttributeNotEmpty("pathSeparator")>pathSeparator: "#JSStringFormat(attributes.pathSeparator)#",</cfif>
		<cfif AttributeNotEmpty("pathSeparatorJS")>pathSeparator: #attributes.pathSeparatorJS#,</cfif>
		...
		<cfif AttributeNotEmpty("root")>root: #attributes.root#,</cfif>
		<cfif AttributeNotEmpty("rootVisible")>rootVisible: #attributes.rootVisible#,</cfif>
		...
		<cfif AttributeNotEmpty("singleExpand")>singleExpand: #attributes.singleExpand#,</cfif>
		...
		<cfif AttributeNotEmpty("useArrows")>useArrows: #attributes.useArrows#,</cfif>
