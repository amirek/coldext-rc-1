...
<!--- defaults --->
<cfparam name="attributes.border" default="false">
<cfparam name="attributes.layout" default="form">
...
<cfparam name="attributes.border" default=""><!--- @@type: Boolean @@help: True to display the borders of the columns body element, false to hide them (defaults to false). --->
...
<cfparam name="attributes.columnWidth" default=""><!--- @@type: Number @@help: Indicates the default status of the filter (defaults to false). --->
...
<cfparam name="attributes.type" default=""><!--- @@type: String @@help: The type of field to use for filtering; boolean, date, list, numeric or string. --->
<cfparam name="attributes.typeJS" default=""><!--- @@type: JS @@help: The type of field to use for filtering; boolean, date, list, numeric or string. --->
<cfparam name="attributes.width" default=""><!--- @@type: Number @@help: The width of this component in pixels (defaults to auto). --->
<cfparam name="attributes.width" default=""><!--- @@type: String @@help: The Ext.data.Store data index of the field this filter represents. The dataIndex does not actually have to exist in the store. --->
<cfparam name="attributes.widthJS" default=""><!--- @@type: JS @@help: The Ext.data.Store data index of the field this filter represents. The dataIndex does not actually have to exist in the store. --->
...
<cfif not thisTag.hasEndTag>
	<cfthrow message="column missing closing tag">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = new (</cfif>{
		...
		<cfif AttributeNotEmpty("width")>width: "#JSStringFormat(attributes.width)#",</cfif>
		<cfif AttributeNotEmpty("widthJS")>width: #attributes.widthJS#,</cfif>
