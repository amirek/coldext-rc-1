...
<!--- attributes --->
<cfparam name="attributes.align" default=""><!--- @@type: String @@help: Set it to 'left' to place action icon next to the group header text. (defaults to undefined = icons are placed at the right side of the group header. --->
<cfparam name="attributes.alignJS" default=""><!--- @@type: JS @@help: Set it to 'left' to place action icon next to the group header text. (defaults to undefined = icons are placed at the right side of the group header. --->
...
<cfset _collection = "groupActions">
