...
<!--- ux resources --->
<cfinclude template="resources/gridpanelresizer.cfm">


<!--- defaults --->

<!--- attributes --->
<cfparam name="attributes.minHeight" default=""><!--- @@type: Number @@help: The minimum height of the grid panel in pixels. --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.ux.PanelResizer({
