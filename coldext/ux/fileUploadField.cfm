...
<!--- ux resources --->
<cfinclude template="resources/fileupload.cfm">


<!--- defaults --->
<cfparam name="attributes.name" default="fileUploadField#Int(Rand()*1000)#">
...
<cfparam name="attributes.buttonOffset" default=""><!--- @@type: Boolean @@help: The number of pixels of space reserved between the button and the text field (defaults to 3). Note that this only applies if buttonOnly = false. --->
<cfparam name="attributes.buttonOnly" default=""><!--- @@type: Boolean @@help: True to display the file upload field as a button with no visible text field (defaults to false). If true, all inherited TextField members will still be available. --->
<cfparam name="attributes.buttonText" default=""><!--- @@type: String @@help: The button text to display on the upload button (defaults to 'Browse...'). Note that if you supply a value for buttonCfg the buttonCfg.text value will be used instead if available. --->
<cfparam name="attributes.buttonTextJS" default=""><!--- @@type: JS @@help: The button text to display on the upload button (defaults to 'Browse...'). Note that if you supply a value for buttonCfg the buttonCfg.text value will be used instead if available. --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.form.FileUploadField({
		...
		<cfif AttributeNotEmpty("buttonOffset")>buttonOffset: #attributes.buttonOffset#,</cfif>
		<cfif AttributeNotEmpty("buttonOnly")>buttonOnly: #attributes.buttonOnly#,</cfif>
		<cfif AttributeNotEmpty("buttonText")>buttonText: "#JSStringFormat(attributes.buttonText)#",</cfif>
		<cfif AttributeNotEmpty("buttonTextJS")>buttonText: #attributes.buttonTextJS#,</cfif>
