...
<cfif ListFind("CF_TOOLBARBUTTON,CF_TOOLBARSPLITBUTTON", parentTag)>
	<cfset _collection = "menu">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.menu.Menu({
