...
<!--- defaults --->
<cfparam name="attributes.name" default="numberField#Int(Rand()*1000)#">
...
<cfparam name="attributes.allowDecimals" default=""><!--- @@type: Boolean @@help: False to disallow decimal values (defaults to true) --->
...
<cfparam name="attributes.allowNegative" default=""><!--- @@type: Boolean @@help: False to prevent entering a negative sign (defaults to true) --->
...
<cfparam name="attributes.baseChars" default=""><!--- @@type: String @@help: The base set of characters to evaluate as valid numbers (defaults to '0123456789'). --->
<cfparam name="attributes.baseCharsJS" default=""><!--- @@type: JS @@help: The base set of characters to evaluate as valid numbers (defaults to '0123456789'). --->
...
<cfparam name="attributes.decimalPrecision" default=""><!--- @@type: Number @@help: The maximum precision to display after the decimal separator (defaults to 2) --->
<cfparam name="attributes.decimalSeparator" default=""><!--- @@type: String @@help: Character(s) to allow as the decimal separator (defaults to '.') --->
<cfparam name="attributes.decimalSeparatorJS" default=""><!--- @@type: JS @@help: Character(s) to allow as the decimal separator (defaults to '.') --->
...
<cfparam name="attributes.fieldClass" default=""><!--- @@type: String @@help: The default CSS class for the field (defaults to "x-form-field x-form-num-field") --->
<cfparam name="attributes.fieldClassJS" default=""><!--- @@type: JS @@help: The default CSS class for the field (defaults to "x-form-field x-form-num-field") --->
...
<cfparam name="attributes.maxText" default=""><!--- @@type: String @@help: Error text to display if the maximum value validation fails (defaults to "The maximum value for this field is {maxValue}") --->
<cfparam name="attributes.maxTextJS" default=""><!--- @@type: JS @@help: Error text to display if the maximum value validation fails (defaults to "The maximum value for this field is {maxValue}") --->
<cfparam name="attributes.maxValue" default=""><!--- @@type: Number @@help: The maximum allowed value (defaults to Number.MAX_VALUE) --->
...
<cfparam name="attributes.minText" default=""><!--- @@type: String @@help: Error text to display if the minimum value validation fails (defaults to "The minimum value for this field is {minValue}") --->
<cfparam name="attributes.minTextJS" default=""><!--- @@type: JS @@help: Error text to display if the minimum value validation fails (defaults to "The minimum value for this field is {minValue}") --->
<cfparam name="attributes.minValue" default=""><!--- @@type: Number @@help: The minimum allowed value (defaults to Number.NEGATIVE_INFINITY) --->
...
<cfparam name="attributes.nanText" default=""><!--- @@type: String @@help: Error text to display if the value is not a valid number. For example, this can happen if a valid character like '.' or '-' is left in the field with no number (defaults to "{value} is not a valid number") --->
<cfparam name="attributes.nanTextJS" default=""><!--- @@type: JS @@help: Error text to display if the value is not a valid number. For example, this can happen if a valid character like '.' or '-' is left in the field with no number (defaults to "{value} is not a valid number") --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.form.NumberField({
		<cfif AttributeNotEmpty("allowBlank")>allowBlank: #attributes.allowBlank#,</cfif>
		<cfif AttributeNotEmpty("allowDecimals")>allowDecimals: #attributes.allowDecimals#,</cfif>
		<cfif AttributeNotEmpty("allowDomMove")>allowDomMove: #attributes.allowDomMove#,</cfif>
		<cfif AttributeNotEmpty("allowNegative")>allowNegative: #attributes.allowNegative#,</cfif>
		...
		<cfif AttributeNotEmpty("baseChars")>baseChars: "#JSStringFormat(attributes.baseChars)#",</cfif>
		<cfif AttributeNotEmpty("baseCharsJS")>baseChars: #attributes.baseCharsJS#,</cfif>
		...
		<cfif AttributeNotEmpty("decimalPrecision")>decimalPrecision: #attributes.decimalPrecision#,</cfif>
		<cfif AttributeNotEmpty("decimalSeparator")>decimalSeparator: "#JSStringFormat(attributes.decimalSeparator)#",</cfif>
		<cfif AttributeNotEmpty("decimalSeparatorJS")>decimalSeparator: #attributes.decimalSeparatorJS#,</cfif>
		...
		<cfif AttributeNotEmpty("maxValue")>maxValue: #attributes.maxValue#,</cfif>
		...
		<cfif AttributeNotEmpty("minValue")>minValue: #attributes.minValue#,</cfif>
		...
		<cfif AttributeNotEmpty("nanText")>nanText: "#JSStringFormat(attributes.nanText)#",</cfif>
		<cfif AttributeNotEmpty("nanTextJS")>nanText: #attributes.nanTextJS#,</cfif>
