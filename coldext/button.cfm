...
<cfparam name="attributes.disabled" default=""><!--- @@type: Boolean @@help: True to start disabled (defaults to false) --->
...
<cfparam name="attributes.hidden" default=""><!--- @@type: Boolean @@help: True to start hidden (defaults to false) --->
...
<cfif ListFind("CF_FORMPANEL", parentTag)>
	<cfset _collection = "buttons">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.Button({
