...
<cfparam name="attributes.animate" default=""><!--- @@type: Boolean @@help: Turn on or off animation. Defaults to true --->
...
<cfparam name="attributes.clickToChange" default=""><!--- @@type: Boolean @@help: Determines whether or not clicking on the Slider axis will change the slider. Defaults to true --->
...
<cfparam name="attributes.increment" default=""><!--- @@type: Number @@help: How many units to change the slider when adjusting by drag and drop. Use this option to enable 'snapping'. --->
...
<cfparam name="attributes.keyIncrement" default=""><!--- @@type: Number @@help: How many units to change the Slider when adjusting with keyboard navigation. Defaults to 1. If the increment config is larger, it will be used instead. --->
...
<cfparam name="attributes.maxValue" default=""><!--- @@type: Number @@help: The maximum value for the Slider. Defaults to 100. --->
<cfparam name="attributes.minValue" default=""><!--- @@type: Number @@help: The minimum value for the Slider. Defaults to 0. --->
...
<cfparam name="attributes.value" default=""><!--- @@type: Number @@help: The value to initialize the slider with. Defaults to minValue. --->
<cfparam name="attributes.vertical" default=""><!--- @@type: Boolean @@help: Orient the Slider vertically rather than horizontally, defaults to false. --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.Slider({
		...
		<cfif AttributeNotEmpty("clickToChange")>clickToChange: #attributes.clickToChange#,</cfif>
		...
		<cfif AttributeNotEmpty("keyIncrement")>keyIncrement: #attributes.keyIncrement#,</cfif>
