...
<cfparam name="attributes.hideOnClick" default=""><!--- @@type: Boolean @@help: True to hide the containing menu after this item is clicked (defaults to false) --->
...
<cfparam name="attributes.itemCls" default=""><!--- @@type: String @@help: The default CSS class to use for text items (defaults to "x-menu-text") --->
<cfparam name="attributes.itemClsJS" default=""><!--- @@type: JS @@help: The default CSS class to use for text items (defaults to "x-menu-text") --->
...
<cfparam name="attributes.text" default=""><!--- @@type: String @@help: The text to display for this item (defaults to '') --->
<cfparam name="attributes.textJS" default=""><!--- @@type: JS @@help: The text to display for this item (defaults to '') --->
...
<cfparam name="attributes.iconCls" default=""><!--- TODO: missing from docs? @@type: String @@help: A css class which sets a background image to be used as the icon for this button --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = new Ext.menu.TextItem(</cfif>{
		...
		<cfif arrayLen(thisTag.items)>menu: #thisTag.items[1]._out#,</cfif>

		<cfif AttributeNotEmpty("iconCls")>iconCls: "#JSStringFormat(attributes.iconCls)#",</cfif>
		<!--- TODO: the items array in this tag outputs to the menu variable! --->
