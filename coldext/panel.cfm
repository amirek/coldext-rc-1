...
<!--- defaults --->
<!--- TODO: is this helpful? (YES?) --->
<cfif ListFind(baseTagList, "CF_FORMPANEL")>
...
<cfparam name="attributes.closable" default=""><!--- TODO: missing form docs? --->
<cfparam name="attributes.padding" default=""><!--- @@type: Number @@help: (ColdExt attribute) The number of pixels to use as padding for the bodyStyle --->
...
<cfif not thisTag.hasEndTag>
	<cfthrow message="panel missing closing tag">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.Panel({
		...
		<!--- tabs --->
		<cfif AttributeNotEmpty("closable")>closable: #attributes.closable#,</cfif><!--- TODO: missing from docs? --->

		<!--- TODO: MISSING FORM DOCS? --->
		<cfif AttributeNotEmpty("region")>region: "#JSStringFormat(attributes.region)#",</cfif>

		<!--- html content --->
		<cfif len(_html)>html: "#_html#",</cfif>
