...
<!--- defaults --->
<cfparam name="attributes.name" default="checkbox#Int(Rand()*1000)#">
...
<cfparam name="attributes.autoCreate" default=""><!--- @@type: String @@help: A DomHelper element spec, or true for a default element spec (defaults to {tag: "input", type: "checkbox", autocomplete: "off"}). --->
<cfparam name="attributes.autoCreateJS" default=""><!--- @@type: String/Object @@help: A DomHelper element spec, or true for a default element spec (defaults to {tag: "input", type: "checkbox", autocomplete: "off"}). --->
...
<cfparam name="attributes.boxLabel" default=""><!--- @@type: String @@help: The text that appears beside the checkbox (defaults to '') --->
<cfparam name="attributes.boxLabelJS" default=""><!--- @@type: JS @@help: The text that appears beside the checkbox (defaults to '') --->
<cfparam name="attributes.checked" default=""><!--- @@type: Boolean @@help: True if the checkbox should render already checked (defaults to false) --->
<cfparam name="attributes.checkedCls" default=""><!--- @@type: String @@help: The CSS class to use when the control is checked (defaults to 'x-form-check-checked'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
<cfparam name="attributes.checkedClsJS" default=""><!--- @@type: JS @@help: The CSS class to use when the control is checked (defaults to 'x-form-check-checked'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
...
<cfparam name="attributes.focusCls" default=""><!--- @@type: String @@help: The CSS class to use when the control receives input focus (defaults to 'x-form-check-focus'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
<cfparam name="attributes.focusClsJS" default=""><!--- @@type: JS @@help: The CSS class to use when the control receives input focus (defaults to 'x-form-check-focus'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
<cfparam name="attributes.handler" default=""><!--- @@type: Function @@help: A function called when the checked value changes (can be used instead of handling the check event). The handler is passed the following parameters:  checkbox : Ext.form.CheckboxThe Checkbox being toggled. checked : BooleanThe new checked state of the checkbox. --->
...
<cfparam name="attributes.inputValue" default=""><!--- @@type: String @@help: The value that should go into the generated input element's value attribute (defaults to undefined, with no value attribute) --->
<cfparam name="attributes.inputValueJS" default=""><!--- @@type: JS @@help: The value that should go into the generated input element's value attribute (defaults to undefined, with no value attribute) --->
...
<cfparam name="attributes.mouseDownCls" default=""><!--- @@type: String @@help: The CSS class to use when the control is being actively clicked (defaults to 'x-form-check-down'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
<cfparam name="attributes.mouseDownClsJS" default=""><!--- @@type: JS @@help: The CSS class to use when the control is being actively clicked (defaults to 'x-form-check-down'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
...
<cfparam name="attributes.overCls" default=""><!--- @@type: String @@help: The CSS class to use when the control is hovered over (defaults to 'x-form-check-over'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
<cfparam name="attributes.overClsJS" default=""><!--- @@type: JS @@help: The CSS class to use when the control is hovered over (defaults to 'x-form-check-over'). Note that this class applies to both checkboxes and radio buttons and is added to the control's wrapper element. --->
...
<cfparam name="attributes.scope" default=""><!--- @@type: Object @@help: An object to use as the scope ("this" reference) of the handler function (defaults to this Checkbox). --->
...
<cfparam name="attributes.tabIndex" default=""><!--- @@type: Number @@help: The tabIndex for this field. Note this only applies to fields that are rendered, not those which are built via applyTo (defaults to 0, which allows the browser to manage the tab index). --->
...
<cfparam name="attributes.disabledClass" default=""><!--- TODO: missing from docs? --->
...
<!--- checkboxGroup --->
<cfif ListFind(baseTagList, "CF_CHECKBOXGROUP") AND AttributeEmpty("boxLabel")>
	<cfset attributes.boxLabel = attributes.fieldLabel>
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.form.Checkbox({
		...
		<cfif AttributeNotEmpty("boxLabel")>boxLabel: "#JSStringFormat(attributes.boxLabel)#",</cfif>
		<cfif AttributeNotEmpty("boxLabelJS")>boxLabel: #attributes.boxLabelJS#,</cfif>
		<cfif AttributeNotEmpty("checked")>checked: #attributes.checked#,</cfif>
		<cfif AttributeNotEmpty("checkedCls")>checkedCls: "#JSStringFormat(attributes.checkedCls)#",</cfif>
		<cfif AttributeNotEmpty("checkedClsJS")>checkedCls: #attributes.checkedClsJS#,</cfif>
		...
		<cfif AttributeNotEmpty("focusCls")>focusCls: "#JSStringFormat(attributes.focusCls)#",</cfif>
		<cfif AttributeNotEmpty("focusClsJS")>focusCls: #attributes.focusClsJS#,</cfif>
		...
		<cfif AttributeNotEmpty("inputValue")>inputValue: "#JSStringFormat(attributes.inputValue)#",</cfif>
		<cfif AttributeNotEmpty("inputValueJS")>inputValue: #attributes.inputValueJS#,</cfif>
		...
		<cfif AttributeNotEmpty("mouseDownCls")>mouseDownCls: "#JSStringFormat(attributes.mouseDownCls)#",</cfif>
		<cfif AttributeNotEmpty("mouseDownClsJS")>mouseDownCls: #attributes.mouseDownClsJS#,</cfif>
