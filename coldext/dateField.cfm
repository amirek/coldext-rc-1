...
<!--- defaults --->
<cfparam name="attributes.name" default="dateField#Int(Rand()*1000)#">
...
<cfparam name="attributes.altFormats" default=""><!--- @@type: String @@help: Multiple date formats separated by "|" to try when parsing a user input value and it doesn't match the defined format (defaults to 'm/d/Y|n/j/Y|n/j/y|m/j/y|n/d/y|m/j/Y|n/d/Y|m-d-y|m-d-Y|m/d|m-d|md|mdy|mdY|d|Y-m-d'). --->
<cfparam name="attributes.altFormatsJS" default=""><!--- @@type: JS @@help: Multiple date formats separated by "|" to try when parsing a user input value and it doesn't match the defined format (defaults to 'm/d/Y|n/j/Y|n/j/y|m/j/y|n/d/y|m/j/Y|n/d/Y|m-d-y|m-d-Y|m/d|m-d|md|mdy|mdY|d|Y-m-d'). --->
...
<cfparam name="attributes.autoCreate" default=""><!--- @@type: String @@help: A DomHelper element spec, or true for a default element spec (defaults to {tag: "input", type: "text", size: "10", autocomplete: "off"}) --->
<cfparam name="attributes.autoCreateJS" default=""><!--- @@type: String/Object @@help: A DomHelper element spec, or true for a default element spec (defaults to {tag: "input", type: "text", size: "10", autocomplete: "off"}) --->
...
<cfparam name="attributes.invalidText" default=""><!--- @@type: String @@help: The error text to display when the date in the field is invalid (defaults to '{value} is not a valid date - it must be in the format {format}'). --->
<cfparam name="attributes.invalidTextJS" default=""><!--- @@type: JS @@help: The error text to display when the date in the field is invalid (defaults to '{value} is not a valid date - it must be in the format {format}'). --->
...
<cfparam name="attributes.maxText" default=""><!--- @@type: String @@help: The error text to display when the date in the cell is after maxValue (defaults to 'The date in this field must be before {maxValue}'). --->
<cfparam name="attributes.maxTextJS" default=""><!--- @@type: JS @@help: The error text to display when the date in the cell is after maxValue (defaults to 'The date in this field must be before {maxValue}'). --->
<cfparam name="attributes.maxValue" default=""><!--- @@type: String @@help: The maximum allowed date. Can be either a Javascript date object or a string date in a valid format (defaults to null). --->
<cfparam name="attributes.maxValueJS" default=""><!--- @@type: Date/String @@help: The maximum allowed date. Can be either a Javascript date object or a string date in a valid format (defaults to null). --->
...
<cfparam name="attributes.minText" default=""><!--- @@type: String @@help: The error text to display when the date in the cell is before minValue (defaults to 'The date in this field must be after {minValue}'). --->
<cfparam name="attributes.minTextJS" default=""><!--- @@type: JS @@help: The error text to display when the date in the cell is before minValue (defaults to 'The date in this field must be after {minValue}'). --->
<cfparam name="attributes.minValue" default=""><!--- @@type: String @@help: The minimum allowed date. Can be either a Javascript date object or a string date in a valid format (defaults to null). --->
<cfparam name="attributes.minValueJS" default=""><!--- @@type: Date/String @@help: The minimum allowed date. Can be either a Javascript date object or a string date in a valid format (defaults to null). --->
...
<cfparam name="attributes.showToday" default=""><!--- @@type: Boolean @@help: False to hide the footer area of the DatePicker containing the Today button and disable the keyboard handler for spacebar that selects the current date (defaults to true). --->
...
<cfparam name="attributes.triggerClass" default=""><!--- @@type: String @@help: An additional CSS class used to style the trigger button. The trigger will always get the class 'x-form-trigger' and triggerClass will be appended if specified (defaults to 'x-form-date-trigger' which displays a calendar icon). --->
<cfparam name="attributes.triggerClassJS" default=""><!--- @@type: JS @@help: An additional CSS class used to style the trigger button. The trigger will always get the class 'x-form-trigger' and triggerClass will be appended if specified (defaults to 'x-form-date-trigger' which displays a calendar icon). --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.form.DateField({
