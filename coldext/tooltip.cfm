...
<cfparam name="attributes.target" default=""><!--- @@type: String @@help: The target HTMLElement, Ext.Element or id to associate with this tooltip. --->
<cfparam name="attributes.targetJS" default=""><!--- @@type: Mixed @@help: The target HTMLElement, Ext.Element or id to associate with this tooltip. --->
...
<cfparam name="attributes.text" default=""><!--- TODO: missing from docs? --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.ToolTip({
		...
		<cfif AttributeNotEmpty("text")>text: "#JSStringFormat(attributes.text)#",</cfif><!--- TODO: missing from docs? --->
