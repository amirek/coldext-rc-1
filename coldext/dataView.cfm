...
<cfparam name="attributes.emptyText" default=""><!--- @@type: String @@help: The text to display in the view when there is no data to display (defaults to ''). --->
<cfparam name="attributes.emptyTextJS" default=""><!--- @@type: JS @@help: The text to display in the view when there is no data to display (defaults to ''). --->
...
<cfparam name="attributes.itemSelector" default=""><!--- @@type: String @@help: This is a required setting. A simple CSS selector (e.g. div.some-class or span:first-child) that will be used to determine what nodes this DataView will be working with. --->
<cfparam name="attributes.itemSelectorJS" default=""><!--- @@type: JS @@help: This is a required setting. A simple CSS selector (e.g. div.some-class or span:first-child) that will be used to determine what nodes this DataView will be working with. --->
...
<cfparam name="attributes.loadingText" default=""><!--- @@type: String @@help: A string to display during data load operations (defaults to undefined). If specified, this text will be displayed in a loading div and the view's contents will be cleared while loading, otherwise the view's contents will continue to display normally until the new data is loaded and the contents are replaced. --->
<cfparam name="attributes.loadingTextJS" default=""><!--- @@type: JS @@help: A string to display during data load operations (defaults to undefined). If specified, this text will be displayed in a loading div and the view's contents will be cleared while loading, otherwise the view's contents will continue to display normally until the new data is loaded and the contents are replaced. --->
<cfparam name="attributes.multiSelect" default=""><!--- @@type: Boolean @@help: True to allow selection of more than one item at a time, false to allow selection of only a single item at a time or no selection at all, depending on the value of singleSelect (defaults to false). --->
<cfparam name="attributes.overClass" default=""><!--- @@type: String @@help: A CSS class to apply to each item in the view on mouseover (defaults to undefined). --->
<cfparam name="attributes.overClassJS" default=""><!--- @@type: JS @@help: A CSS class to apply to each item in the view on mouseover (defaults to undefined). --->
...
<cfparam name="attributes.selectedClass" default=""><!--- @@type: String @@help: A CSS class to apply to each selected item in the view (defaults to 'x-view-selected'). --->
<cfparam name="attributes.selectedClassJS" default=""><!--- @@type: JS @@help: A CSS class to apply to each selected item in the view (defaults to 'x-view-selected'). --->
<cfparam name="attributes.simpleSelect" default=""><!--- @@type: Boolean @@help: True to enable multiselection by clicking on multiple items without requiring the user to hold Shift or Ctrl, false to force the user to hold Ctrl or Shift to select more than on item (defaults to false). --->
<cfparam name="attributes.singleSelect" default=""><!--- @@type: Boolean @@help: True to allow selection of exactly one item at a time, false to allow no selection at all (defaults to false). Note that if multiSelect = true, this value will be ignored. --->
...
<cfparam name="attributes.store" default=""><!--- @@type: Ext.data.Store @@help: The Ext.data.Store to bind this DataView to. --->
...
<cfparam name="attributes.tpl" default=""><!--- @@type: String @@help: The HTML fragment or an array of fragments that will make up the template used by this DataView. This should be specified in the same format expected by the constructor of Ext.XTemplate. --->
<cfparam name="attributes.tplJS" default=""><!--- @@type: String/Array @@help: The HTML fragment or an array of fragments that will make up the template used by this DataView. This should be specified in the same format expected by the constructor of Ext.XTemplate. --->
<cfparam name="attributes.trackOver" default=""><!--- @@type: Boolean @@help: True to enable mouseenter and mouseleave events --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.DataView({
		...
		<cfif AttributeNotEmpty("multiSelect")>multiSelect: #attributes.multiSelect#,</cfif>
		<cfif AttributeNotEmpty("overClass")>overClass: "#JSStringFormat(attributes.overClass)#",</cfif>
		<cfif AttributeNotEmpty("overClassJS")>overClass: #attributes.overClassJS#,</cfif>
		...
		<cfif AttributeNotEmpty("simpleSelect")>simpleSelect: #attributes.simpleSelect#,</cfif>
		...
		<cfif AttributeNotEmpty("trackOver")>trackOver: #attributes.trackOver#,</cfif>
