...
<cfparam name="attributes.displayInfo" default=""><!--- @@type: Boolean @@help: True to display the displayMsg (defaults to false) --->
<cfparam name="attributes.displayMsg" default=""><!--- @@type: String @@help: The paging status message to display (defaults to "Displaying {0} - {1} of {2}"). Note that this string is formatted using the braced numbers 0-2 as tokens that are replaced by the values for start, end and total respectively. These tokens should be preserved when overriding this string if showing those values is desired. --->
<cfparam name="attributes.displayMsgJS" default=""><!--- @@type: JS @@help: The paging status message to display (defaults to "Displaying {0} - {1} of {2}"). Note that this string is formatted using the braced numbers 0-2 as tokens that are replaced by the values for start, end and total respectively. These tokens should be preserved when overriding this string if showing those values is desired. --->
<cfparam name="attributes.emptyMsg" default=""><!--- @@type: String @@help: The message to display when no records are found (defaults to "No data to display") --->
<cfparam name="attributes.emptyMsgJS" default=""><!--- @@type: JS @@help: The message to display when no records are found (defaults to "No data to display") --->
...
<cfparam name="attributes.pageSize" default=""><!--- @@type: Number @@help: The number of records to display per page (defaults to 20) --->
...
<cfparam name="attributes.store" default=""><!--- @@type: Ext.data.Store @@help: The Ext.data.Store the paging toolbar should use as its data source (required). --->
...
<cfif attributes.position eq "top">
	<cfset _collection = "tbar">
</cfif>
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.PagingToolbar({
		...
		<cfif AttributeNotEmpty("displayInfo")>displayInfo: #attributes.displayInfo#,</cfif>
		<cfif AttributeNotEmpty("displayMsg")>displayMsg: "#JSStringFormat(attributes.displayMsg)#",</cfif>
		<cfif AttributeNotEmpty("displayMsgJS")>displayMsg: #attributes.displayMsgJS#,</cfif>
		<cfif AttributeNotEmpty("emptyMsg")>emptyMsg: "#JSStringFormat(attributes.emptyMsg)#",</cfif>
		<cfif AttributeNotEmpty("emptyMsgJS")>emptyMsg: #attributes.emptyMsgJS#,</cfif>
