...
<!--- defaults --->
<cfparam name="attributes.name" default="textArea#Int(Rand()*1000)#">
...
<cfparam name="attributes.autoCreate" default=""><!--- @@type: String @@help: A DomHelper element spec, or true for a default element spec (defaults to {tag: "textarea", style: "width:100px;height:60px;", autocomplete: "off"}) --->
<cfparam name="attributes.autoCreateJS" default=""><!--- @@type: String/Object @@help: A DomHelper element spec, or true for a default element spec (defaults to {tag: "textarea", style: "width:100px;height:60px;", autocomplete: "off"}) --->
...
<cfparam name="attributes.growMax" default=""><!--- @@type: Number @@help: The maximum height to allow when grow = true (defaults to 1000) --->
<cfparam name="attributes.growMin" default=""><!--- @@type: Number @@help: The minimum height to allow when grow = true (defaults to 60) --->
...
<cfparam name="attributes.preventScrollbars" default=""><!--- @@type: Boolean @@help: True to prevent scrollbars from appearing regardless of how much text is in the field (equivalent to setting overflow: hidden, defaults to false) --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.form.TextArea({
		...
		<cfif AttributeNotEmpty("preventScrollbars")>preventScrollbars: #attributes.preventScrollbars#,</cfif>
