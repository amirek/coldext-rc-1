...
<cfparam name="attributes.autoHide" default=""><!--- @@type: Boolean @@help: True to automatically hide the tooltip after the mouse exits the target element or after the dismissDelay has expired if set (defaults to true). If closable = true a close tool button will be rendered into the tooltip header. --->
...
<cfparam name="attributes.closable" default=""><!--- @@type: Boolean @@help: True to render a close tool button into the tooltip header (defaults to false). --->
...
<cfparam name="attributes.defaultAlign" default=""><!--- @@type: String @@help: Experimental. The default Ext.Element.alignTo anchor position value for this tip relative to its element of origin (defaults to "tl-bl?"). --->
<cfparam name="attributes.defaultAlignJS" default=""><!--- @@type: JS @@help: Experimental. The default Ext.Element.alignTo anchor position value for this tip relative to its element of origin (defaults to "tl-bl?"). --->
...
<cfparam name="attributes.dismissDelay" default=""><!--- @@type: Number @@help: Delay in milliseconds before the tooltip automatically hides (defaults to 5000). To disable automatic hiding, set dismissDelay = 0. --->
...
<cfparam name="attributes.hideDelay" default=""><!--- @@type: Number @@help: Delay in milliseconds after the mouse exits the target element but before the tooltip actually hides (defaults to 200). Set to 0 for the tooltip to hide immediately. --->
...
<cfparam name="attributes.interceptTitles" default=""><!--- @@type: Boolean @@help: True to automatically use the element's DOM title value if available (defaults to false). --->
...
<cfparam name="attributes.maxWidth" default=""><!--- @@type: Number @@help: The maximum width of the tip in pixels (defaults to 300). The maximum supported value is 500. --->
...
<cfparam name="attributes.minWidth" default=""><!--- @@type: Number @@help: The minimum width of the tip in pixels (defaults to 40). --->
...
<cfparam name="attributes.mouseOffset" default=""><!--- @@type: Array @@help: An XY offset from the mouse position where the tooltip should be shown (defaults to [15,18]). --->
...
<cfparam name="attributes.showDelay" default=""><!--- @@type: Number @@help: Delay in milliseconds before the tooltip displays after the mouse enters the target element (defaults to 500) --->
...
<cfparam name="attributes.target" default=""><!--- @@type: String @@help: The target HTMLElement, Ext.Element or id to associate with this quicktip (defaults to the document). --->
<cfparam name="attributes.targetJS" default=""><!--- @@type: Mixed @@help: The target HTMLElement, Ext.Element or id to associate with this quicktip (defaults to the document). --->
...
<cfparam name="attributes.trackMouse" default=""><!--- @@type: Boolean @@help: True to have the tooltip follow the mouse as it moves over the target element (defaults to false). --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.QuickTip({
		...
		<cfif AttributeNotEmpty("dismissDelay")>dismissDelay: #attributes.dismissDelay#,</cfif>
		...
		<cfif AttributeNotEmpty("interceptTitles")>interceptTitles: #attributes.interceptTitles#,</cfif>
		...
		<cfif AttributeNotEmpty("maxWidth")>maxWidth: #attributes.maxWidth#,</cfif>
		...
		<cfif AttributeNotEmpty("mouseOffset")>mouseOffset: #attributes.mouseOffset#,</cfif>
		...
		<cfif AttributeNotEmpty("target")>target: "#JSStringFormat(attributes.target)#",</cfif>
		<cfif AttributeNotEmpty("targetJS")>target: #attributes.targetJS#,</cfif>
		...
		<cfif AttributeNotEmpty("trackMouse")>trackMouse: #attributes.trackMouse#,</cfif>
