...
<cfparam name="attributes.cancelText" default=""><!--- @@type: String @@help: The text to display on the cancel button --->
<cfparam name="attributes.cancelTextJS" default=""><!--- @@type: JS @@help: The text to display on the cancel button --->
...
<cfparam name="attributes.constrainToViewport" default=""><!--- @@type: Boolean @@help: Deprecated (not currently used). True to constrain the date picker to the viewport (defaults to true) --->
...
<cfparam name="attributes.dayNames" default=""><!--- @@type: Array @@help: An array of textual day names which can be overriden for localization support (defaults to Date.dayNames) --->
...
<cfparam name="attributes.disabledDates" default=""><!--- @@type: Array @@help: An array of "dates" to disable, as strings. These strings will be used to build a dynamic regular expression so they are very powerful. Some examples:  ["03/08/2003", "09/16/2003"] would disable those exact dates ["03/08", "09/16"] would disable those days for every year ["^03/08"] would only match the beginning (useful if you are using short years) ["03/../2006"] would disable every day in March 2006 ["^03"] would disable every day in every March  Note that the format of the dates included in the array should exactly match the format config. In order to support regular expressions, if you are using a date format that has "." in it, you will have to escape the dot when restricting dates. For example: ["03\\.08\\.03"]. --->
<cfparam name="attributes.disabledDatesRE" default=""><!--- @@type: RegExp @@help: JavaScript regular expression used to disable a pattern of dates (defaults to null). The disabledDates config will generate this regex internally, but if you specify disabledDatesRE it will take precedence over the disabledDates value. --->
<cfparam name="attributes.disabledDatesText" default=""><!--- @@type: String @@help: The tooltip text to display when the date falls on a disabled date (defaults to "Disabled") --->
<cfparam name="attributes.disabledDatesTextJS" default=""><!--- @@type: JS @@help: The tooltip text to display when the date falls on a disabled date (defaults to "Disabled") --->
<cfparam name="attributes.disabledDays" default=""><!--- @@type: Array @@help: An array of days to disable, 0-based. For example, [0, 6] disables Sunday and Saturday (defaults to null). --->
<cfparam name="attributes.disabledDaysText" default=""><!--- @@type: String @@help: The tooltip to display when the date falls on a disabled day (defaults to "Disabled") --->
<cfparam name="attributes.disabledDaysTextJS" default=""><!--- @@type: JS @@help: The tooltip to display when the date falls on a disabled day (defaults to "Disabled") --->
...
<cfparam name="attributes.format" default=""><!--- @@type: String @@help: The default date format string which can be overriden for localization support. The format must be valid according to Date.parseDate (defaults to 'm/d/y'). --->
<cfparam name="attributes.formatJS" default=""><!--- @@type: JS @@help: The default date format string which can be overriden for localization support. The format must be valid according to Date.parseDate (defaults to 'm/d/y'). --->
...
<cfparam name="attributes.maxDate" default=""><!--- @@type: Date @@help: Maximum allowable date (JavaScript date object, defaults to null) --->
<cfparam name="attributes.maxText" default=""><!--- @@type: String @@help: The error text to display if the maxDate validation fails (defaults to "This date is after the maximum date") --->
<cfparam name="attributes.maxTextJS" default=""><!--- @@type: JS @@help: The error text to display if the maxDate validation fails (defaults to "This date is after the maximum date") --->
<cfparam name="attributes.minDate" default=""><!--- @@type: Date @@help: Minimum allowable date (JavaScript date object, defaults to null) --->
<cfparam name="attributes.minText" default=""><!--- @@type: String @@help: The error text to display if the minDate validation fails (defaults to "This date is before the minimum date") --->
<cfparam name="attributes.minTextJS" default=""><!--- @@type: JS @@help: The error text to display if the minDate validation fails (defaults to "This date is before the minimum date") --->
<cfparam name="attributes.monthNames" default=""><!--- @@type: Array @@help: An array of textual month names which can be overriden for localization support (defaults to Date.monthNames) --->
<cfparam name="attributes.monthYearText" default=""><!--- @@type: String @@help: The header month selector tooltip (defaults to 'Choose a month (Control+Up/Down to move years)') --->
<cfparam name="attributes.monthYearTextJS" default=""><!--- @@type: JS @@help: The header month selector tooltip (defaults to 'Choose a month (Control+Up/Down to move years)') --->
<cfparam name="attributes.nextText" default=""><!--- @@type: String @@help: The next month navigation button tooltip (defaults to 'Next Month (Control+Right)') --->
<cfparam name="attributes.nextTextJS" default=""><!--- @@type: JS @@help: The next month navigation button tooltip (defaults to 'Next Month (Control+Right)') --->
<cfparam name="attributes.okText" default=""><!--- @@type: String @@help: The text to display on the ok button --->
<cfparam name="attributes.okTextJS" default=""><!--- @@type: JS @@help: The text to display on the ok button --->
...
<cfparam name="attributes.prevText" default=""><!--- @@type: String @@help: The previous month navigation button tooltip (defaults to 'Previous Month (Control+Left)') --->
<cfparam name="attributes.prevTextJS" default=""><!--- @@type: JS @@help: The previous month navigation button tooltip (defaults to 'Previous Month (Control+Left)') --->
...
<cfparam name="attributes.showToday" default=""><!--- @@type: Boolean @@help: False to hide the footer area containing the Today button and disable the keyboard handler for spacebar that selects the current date (defaults to true). --->
<cfparam name="attributes.startDay" default=""><!--- @@type: Number @@help: Day index at which the week should begin, 0-based (defaults to 0, which is Sunday) --->
...
<cfparam name="attributes.todayText" default=""><!--- @@type: String @@help: The text to display on the button that selects the current date (defaults to "Today") --->
<cfparam name="attributes.todayTextJS" default=""><!--- @@type: JS @@help: The text to display on the button that selects the current date (defaults to "Today") --->
<cfparam name="attributes.todayTip" default=""><!--- @@type: String @@help: The tooltip to display for the button that selects the current date (defaults to "{current date} (Spacebar)") --->
<cfparam name="attributes.todayTipJS" default=""><!--- @@type: JS @@help: The tooltip to display for the button that selects the current date (defaults to "{current date} (Spacebar)") --->
...
<cfoutput>
	<cfif AttributeNotEmpty("var")>var #attributes.var# = </cfif>new Ext.DatePicker({
		...
		<cfif AttributeNotEmpty("cancelText")>cancelText: "#JSStringFormat(attributes.cancelText)#",</cfif>
		<cfif AttributeNotEmpty("cancelTextJS")>cancelText: #attributes.cancelTextJS#,</cfif>
		...
		<cfif AttributeNotEmpty("constrainToViewport")>constrainToViewport: #attributes.constrainToViewport#,</cfif>
		...
		<cfif AttributeNotEmpty("dayNames")>dayNames: #attributes.dayNames#,</cfif>
		...
		<cfif AttributeNotEmpty("disabledDates")>disabledDates: #attributes.disabledDates#,</cfif>
		<cfif AttributeNotEmpty("disabledDatesRE")>disabledDatesRE: #attributes.disabledDatesRE#,</cfif>
		<cfif AttributeNotEmpty("disabledDatesText")>disabledDatesText: "#JSStringFormat(attributes.disabledDatesText)#",</cfif>
		<cfif AttributeNotEmpty("disabledDatesTextJS")>disabledDatesText: #attributes.disabledDatesTextJS#,</cfif>
		<cfif AttributeNotEmpty("disabledDays")>disabledDays: #attributes.disabledDays#,</cfif>
		<cfif AttributeNotEmpty("disabledDaysText")>disabledDaysText: "#JSStringFormat(attributes.disabledDaysText)#",</cfif>
		<cfif AttributeNotEmpty("disabledDaysTextJS")>disabledDaysText: #attributes.disabledDaysTextJS#,</cfif>
		...
		<cfif AttributeNotEmpty("maxDate")>maxDate: #attributes.maxDate#,</cfif>
		...
		<cfif AttributeNotEmpty("minDate")>minDate: #attributes.minDate#,</cfif>
		...
		<cfif AttributeNotEmpty("monthNames")>monthNames: #attributes.monthNames#,</cfif>
		<cfif AttributeNotEmpty("monthYearText")>monthYearText: "#JSStringFormat(attributes.monthYearText)#",</cfif>
		<cfif AttributeNotEmpty("monthYearTextJS")>monthYearText: #attributes.monthYearTextJS#,</cfif>
		<cfif AttributeNotEmpty("nextText")>nextText: "#JSStringFormat(attributes.nextText)#",</cfif>
		<cfif AttributeNotEmpty("nextTextJS")>nextText: #attributes.nextTextJS#,</cfif>
		<cfif AttributeNotEmpty("okText")>okText: "#JSStringFormat(attributes.okText)#",</cfif>
		<cfif AttributeNotEmpty("okTextJS")>okText: #attributes.okTextJS#,</cfif>
		...
		<cfif AttributeNotEmpty("prevText")>prevText: "#JSStringFormat(attributes.prevText)#",</cfif>
		<cfif AttributeNotEmpty("prevTextJS")>prevText: #attributes.prevTextJS#,</cfif>
		...
		<cfif AttributeNotEmpty("showToday")>showToday: #attributes.showToday#,</cfif>
		<cfif AttributeNotEmpty("startDay")>startDay: #attributes.startDay#,</cfif>
		...
		<cfif AttributeNotEmpty("todayText")>todayText: "#JSStringFormat(attributes.todayText)#",</cfif>
		<cfif AttributeNotEmpty("todayTextJS")>todayText: #attributes.todayTextJS#,</cfif>
		<cfif AttributeNotEmpty("todayTip")>todayTip: "#JSStringFormat(attributes.todayTip)#",</cfif>
		<cfif AttributeNotEmpty("todayTipJS")>todayTip: #attributes.todayTipJS#,</cfif>
